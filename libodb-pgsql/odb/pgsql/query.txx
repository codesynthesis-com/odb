...
namespace odb
{
  namespace pgsql
  {
        ...
        : binding_ (0, 0), native_binding_ (0, 0, 0, 0)
    {
      ...
      c.append (*this, val_bind<bool> (true), c.conversion ());
    }
    ...
    in (decayed_type v1, decayed_type v2) const
    {
      ...
      q += "IN (";
      q.append<T, ID> (val_bind<T> (v1), this->conversion_);
      q += ",";
      q.append<T, ID> (val_bind<T> (v2), this->conversion_);
      q += ")";
      return q;
    }
    ...
    in (decayed_type v1, decayed_type v2, decayed_type v3) const
    {
      ...
      q.append<T, ID> (val_bind<T> (v2), this->conversion_);
      q += ",";
      q.append<T, ID> (val_bind<T> (v3), this->conversion_);
      q += ")";
      return q;
    }
        ...
        decayed_type v4) const
    {
      ...
      q.append<T, ID> (val_bind<T> (v3), this->conversion_);
      q += ",";
      q.append<T, ID> (val_bind<T> (v4), this->conversion_);
      q += ")";
      return q;
    }
        ...
        decayed_type v5) const
    {
      ...
      q.append<T, ID> (val_bind<T> (v4), this->conversion_);
      q += ",";
      q.append<T, ID> (val_bind<T> (v5), this->conversion_);
      q += ")";
      return q;
    }
    ...
    in_range (I begin, I end) const
    {
      if (begin != end)
      {
        ...
        for (I i (begin); i != end; ++i)
        {
          ...
          q.append<T, ID> (val_bind<T> (*i), this->conversion_);
        }
    ...
    like (val_bind<T> p) const
    {
      query_base q (this->table_, this->column_);
      q += "LIKE";
      q.append<T, ID> (p, this->conversion_);
      return q;
    }
    ...
    like (val_bind<T> p, decayed_type e) const
    {
      ...
      q.append<T, ID> (p, this->conversion_);
      q += "ESCAPE";
      q.append<T, ID> (val_bind<T> (e), this->conversion_);
      return q;
    }
