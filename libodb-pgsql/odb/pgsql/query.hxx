  ...
  namespace pgsql
  {
    ...
    public:
      ...
      equal (val_bind<T> v) const
      {
        query_base q (this->table_, this->column_);
        q += "=";
        this->append (q, v, this->conversion_);
        return q;
      }
      ...
      equal (ref_bind<T> r) const
      {
        query_base q (this->table_, this->column_);
        q += "=";
        this->append (q, r, this->conversion_);
        return q;
      }
    ...
    public:
      ...
      unequal (val_bind<T> v) const
      {
        query_base q (this->table_, this->column_);
        q += "!=";
        q.append<T, ID> (v, this->conversion_);
        return q;
      }
      ...
      unequal (ref_bind<T> r) const
      {
        query_base q (this->table_, this->column_);
        q += "!=";
        q.append<T, ID> (r, this->conversion_);
        return q;
      }
...
namespace odb
{
  ...
  public:
    ...
    template <pgsql::database_type_id ID, typename B>
    query (const pgsql::query_column<bool, ID, B>& qc)
        : pgsql::query<T> (qc)
    {
    }
  };
