...
namespace relational
{
  namespace source
  {
      ...
      pre (member_info& mi)
      {
        ...
        if (!member_override_.empty ())
        {
          ...
          if (mi.ptr != 0 && direct_load_pointer (mi.m, key_prefix_))
          {
            ...
            return true; // That's enough for direct load object pointer.
          }
        }
        else
        {
      ...
      virtual member_base, member_base_impl<bool> // Dummy SQL type.
    {
      ...
      // @@ N+1: feels like we probably don't need ct, fq_type.
      //
      ...
      pre (member_info& mi)
      {
        ...
        //
        return mi.ptr != 0 && direct_load_pointer (mi.m, key_prefix_);
      }
      ...
      traverse_pointer (member_info& mi)
      {
        ...
        else // post
        {
          ...
          if (!viewm)
          {
            ...
            if (weak_pointer (utype (mi.m, key_prefix_)))
            {
