    ...
    //
    {
      ...
      //
      {
...

        {
          ...
          //
          {
            object v1 (db->query_value<object> (q::source == o1.id));
            assert (v1 == o2);

            object v2 (db->query_value<object> (q::source.is_null ()));
            assert (v2 == o1);

            // @@ TMP Enable when warning suppression is supported in ODB
            //        compiler (see null_object_id definition for details).
#if 0
            null_object_id id;
