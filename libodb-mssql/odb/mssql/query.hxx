...
namespace odb
{
  namespace mssql
  {
    ...
    public:
      ...
      template <typename T, database_type_id ID, typename B>
      query_base&
      operator+= (const query_column<T, ID, B>&);
    ...
    operator+= (const query_column<T, ID, B>& c)
    {
...
namespace odb
{
  ...
  public:
    ...
    template <mssql::database_type_id ID, typename B>
    query (const mssql::query_column<bool, ID, B>& qc)
        : mssql::query<T> (qc)
    {
    }
  };
