...
namespace odb
{
  namespace mysql
  {
    ...
    public:
      ...
      // binding is a subset of the full binding (skipping id).
      //
      data_image_type&
      data_image ()
      {
    ...
    private:
      ...
      MYSQL_BIND select_image_bind_[traits::select_column_count];
      my_bool select_image_truncated_array_[traits::select_column_count];
    };
